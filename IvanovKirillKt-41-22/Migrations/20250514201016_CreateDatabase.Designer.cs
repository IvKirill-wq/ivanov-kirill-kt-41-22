...
namespace IvanovKirillKt_41_22.Migrations
{
    ...
    [Migration("20250514201016_CreateDatabase")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IvanovKirillKt_41_22.Models.AcademicDegree", b =>
                {
                    b.Property<int>("ADId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("IvanovKirillKt_41_22.Models.Department", b =>
                {
            ...
            modelBuilder.Entity("IvanovKirillKt_41_22.Models.Direction", b =>
                {
            ...
            modelBuilder.Entity("IvanovKirillKt_41_22.Models.Discipline", b =>
                {
                    b.Property<int>("DisciplineId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("IvanovKirillKt_41_22.Models.Position", b =>
                {
            ...
            modelBuilder.Entity("IvanovKirillKt_41_22.Models.Teacher", b =>
                {
                    b.Property<int>("TeacherId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("IvanovKirillKt_41_22.Models.Department", b =>
                {
                    b.HasOne("IvanovKirillKt_41_22.Models.Teacher", "HeadTeacher")
                        .WithOne()
                        .HasForeignKey("IvanovKirillKt_41_22.Models.Department", "HeadTeacherId")
            ...
            modelBuilder.Entity("IvanovKirillKt_41_22.Models.Direction", b =>
                {
                    b.HasOne("IvanovKirillKt_41_22.Models.Discipline", "Discipline")
                        .WithMany()
                    ...
                    b.HasOne("IvanovKirillKt_41_22.Models.Teacher", "Teacher")
                        .WithMany()
            ...
            modelBuilder.Entity("IvanovKirillKt_41_22.Models.Teacher", b =>
                {
                    b.HasOne("IvanovKirillKt_41_22.Models.AcademicDegree", "AcademicDegree")
                        .WithMany()
                        .HasForeignKey("ADId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                    ...
                    b.HasOne("IvanovKirillKt_41_22.Models.Department", "Department")
                        .WithMany()
                    ...
                    b.HasOne("IvanovKirillKt_41_22.Models.Position", "Position")
                        .WithMany()
